...
conv3 = layers.Conv2D(filters=32, kernel_size=(3, 3), strides=(2, 2))(rescale) # 2
...
brb_1_outputs = layers.Conv2D(filters=48, kernel_size=(1, 1), activation='linear')(brb_1_relu2) # 9
...
brb_2_outputs = layers.Conv2D(filters=64, kernel_size=(1, 1), activation='linear')(brb_2_relu2) # 20
...
brb_3_outputs = layers.Conv2D(filters=128, kernel_size=(1, 1), activation='linear')(brb_3_relu2) # 32
...
brb_4_outputs = layers.Conv2D(filters=196, kernel_size=(1, 1), activation='linear')(brb_4_relu2) # 45
...
brb_5_outputs = layers.Conv2D(filters=360, kernel_size=(1, 1), activation='linear')(brb_5_relu2) # 59
# stem
